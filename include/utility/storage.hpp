...
For example, reference types are stored as boost::reference_wrapper's.
*/

#ifndef RANGE_DETAIL_STORAGE_HPP_INCLUDED
#define RANGE_DETAIL_STORAGE_HPP_INCLUDED
...
#endif  // RANGE_DETAIL_STORAGE_HPP_INCLUDED
