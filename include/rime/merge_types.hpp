...
namespace merge_policy {
    ...
    */
    template <
        class MergeTwo, class Type1, class Type2,
    ...
    struct lazy<MergeTwo, Type1, Type2, Transform>
    {
        typedef typename Transform<
            typename MergeTwo::template apply<Type1, Type2>::type>::type type;
    };
    ...
    : boost::mpl::if_<
          is_implemented<MergeTwo, Type1, Type2>,
    ...
    */
    ...
    {
        template <class Type1, class Type2, class Enable1 = void> struct apply
        {};

        template <class Type1, class Type2> struct apply<
            Type1, Type2,
            typename boost::enable_if<std::is_base_of<Type1, Type2>>::type>
        {
            typedef Type1 type;
        };
        ...
        template <class Type1, class Type2> struct apply<
            Type1, Type2,
            typename boost::enable_if<std::is_base_of<Type2, Type1>>::type>
        {
            typedef Type2 type;
        };
    };
    ...
    */
    struct collapse
    {
        ...
        template <class Type1, class Type2> struct apply<Type1 &, Type2 const &>
        : merge_transform<
              base_class, Type1, Type2, std::add_const,
...
namespace merge_detail {
    ...
    */
    ...
    template <
        typename MergeTwo, typename New, typename First, typename... Rest,
        typename Else>
    ...
    {
        typedef insert_impl<MergeTwo, New, meta::vector<Rest...>> merge_rest;
        ...
        typedef typename merge_first_else<
            MergeTwo, merged_new, typename meta::push<First, merged_rest>::type,
            boost::mpl::pair<
                merged_new,
                typename meta::push<First, merged_rest>::type>>::type type;
    };

    template <typename MergeTwo, typename New, typename First, typename... Rest>
    struct insert_impl<MergeTwo, New, meta::vector<First, Rest...>>
    : merge_first_else<
          MergeTwo, New, meta::vector<First, Rest...>,
          // Else =
...
*/
template <typename MergeTwo, typename Types> struct merge_types
: meta::fold<
      meta::back,
