...
namespace rime { namespace detail {
    ...
    */
    template <typename Result, class Arguments, class Choices>
    struct switch_impl;

    template <typename Result, typename... Arguments, class... Choices>
    struct switch_impl<
        Result, meta::vector<Arguments...>, meta::vector<Choices...>>
    {
        switch_impl()
        {
    ...
    private:
        ...
        static void set_pointers(
            function_pointer * destination, FirstPointer first_pointer,
            OtherPointers... other_pointers)
        {
    ...
    */
    ...
    {
        template <typename... Arguments> ResultType operator()(
            std::size_t which, Arguments &&... arguments) const
        {
            typedef switch_impl<
                ResultType, meta::vector<Arguments...>,
                meta::vector<Choices...>>
                implementation_type;
