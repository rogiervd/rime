    ...
    namespace callable {                                                     \
        ...
        {                                                                    \
            ...
            {                                                                \
                ...
                return constant<                                             \
                    ValueType, (Left::value operation Right::value)>();      \
            }                                                                \
                                                                             \
            template <class Left, class Right>                               \
            auto operator()(Left const & left, Right const & right) const -> \
                typename boost::disable_if<                                  \
                    mpl::and_<is_constant<Left>, is_constant<Right>>,        \
                    decltype((get_value(left)                                \
                                  operation get_value(right)))>::type        \
            {                                                                \
        ...
        {                                                                      \
            ...
            auto operator()(Argument const & argument) const ->                \
                typename boost::enable_if<                                     \
                    ...
                    constant<                                                  \
                        typename std::decay<                                   \
                            decltype(operation Argument::value)>::type,        \
                        (operation Argument::value)>>::type                    \
            {                                                                  \
                typedef typename std::decay<                                   \
                    decltype(operation Argument::value)>::type ValueType;      \
            ...
            auto operator()(Argument const & argument) const ->                \
                typename boost::disable_if<                                    \
                    is_constant<Argument>,                                     \
                    decltype(operation get_value(argument))>::type             \
            {                                                                  \
    ...
    auto operator operation(Argument const & argument)                         \
        ->typename boost::enable_if<                                           \
            ...
            constant<                                                          \
                ...
                (operation Argument::value)>>::type                            \
    {                                                                          \
        typedef typename std::decay<decltype(operation Argument::value)>::type \
            ValueType;                                                         \
        return constant<ValueType, (operation Argument::value)>();             \
    }
...
namespace callable {
    ...
    namespace detail {
        ...
        template <typename Constant> struct any_equal_constant<Constant>
        : mpl::false_
        {};
        ...
        template <typename Constant> struct all_equal_constant<Constant>
        : mpl::true_
        {};
        template <typename Constant, typename Head, typename... Tail>
...
#define RIME_DEFINE_BINARY_BOOLEAN_OPERATOR(                                   \
    ...
    namespace callable {                                                       \
        namespace detail {                                                     \
            template <typename Void, typename... Arguments>                    \
            struct name##runtime;                                              \
            ...
            {                                                                  \
                bool operator()() const { return defaultValue; }               \
                                                                               ...
                                                                               \
            template <typename Head, typename... Tail> struct name##runtime<   \
                typename boost::disable_if<is_constant<Head>>::type, Head,     \
                Tail...>                                                       \
            {                                                                  \
                ...
                {                                                              \
                    ...
                    return head operation child(tail...);                      \
                                                                               ...
                                                                               \
            template <typename Head, typename... Tail> struct name##runtime<   \
                typename boost::enable_if<is_constant<Head>>::type, Head,      \
                Tail...>                                                       \
            {                                                                  \
        ...
        {                                                                      \
            ...
            : mpl::if_<                                                        \
                  detail::any_equal_constant<                                  \
                      bool_<overrideValue>, Arguments...>,                     \
                  return_<bool_<overrideValue>>,                               \
                  typename mpl::if_<                                           \
                      detail::all_equal_constant<                              \
                          bool_<defaultValue>, Arguments...>,                  \
                      return_<bool_<defaultValue>>,                            \
                      detail::name##runtime<void, Arguments...>>::type>::type  \
            {};                                                                \
                                                                               \
        public:                                                                \
            template <typename... Arguments>                                   \
    ...
    auto operator operation(Left const & left, Right const & right)            \
        ->typename boost::enable_if<                                           \
            mpl::and_<                                                         \
                is_constant<Left>, is_constant<Right>,                         \
                mpl::or_<is_rime_constant<Left>, is_rime_constant<Right>>>,    \
            bool_<(Left::value operation Right::value)>>::type                 \
    {                                                                          \
