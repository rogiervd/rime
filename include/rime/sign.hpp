...
namespace types {
    ...
    */
    ...
    : boost::mpl::eval_if<
          std::is_integral<Type>, std::is_signed<Type>, std::false_type>
    {};
    template <class Type> struct std_is_unsigned
    : boost::mpl::eval_if<
          std::is_integral<Type>, std::is_unsigned<Type>, std::false_type>
    {};

    template <class Type> struct is_signed
    : rime::as_rime_constant<typename std_is_signed<typename rime::value<
          typename std::remove_cv<Type>::type>::type>::type>::type
    {};

    template <class Type> struct is_unsigned
    : rime::as_rime_constant<typename std_is_unsigned<typename rime::value<
          typename std::remove_cv<Type>::type>::type>::type>::type
    {};
    ...
    namespace detail {
        ...
        struct convert_constant
        {
            ...
            typedef
                typename rime::value<decayed_type>::type original_value_type;
            typedef typename Convert<original_value_type>::type value_type;

            typedef rime::constant<value_type, value_type(decayed_type::value)>
                type;
        };
        ...
        : boost::mpl::eval_if<
              rime::is_constant<Type>, convert_constant<Convert, Type>,
              boost::mpl::eval_if<
                  std::is_integral<Type>, Convert<Type>, mpl::identity<Type>>>
        {};
...
namespace callable {
    ...
    template <template <class> class Convert> struct convert_integral_value
    {
        ...
        template <class Type> typename boost::enable_if<
            is_constant<Type>, typename result<Type>::type>::type
        ...
        template <class Type> typename boost::disable_if<
            is_constant<Type>, typename result<Type>::type>::type
    ...
    struct make_zero
    {
        ...
        template <class Type> typename boost::lazy_enable_if<
            rime::is_constant<Type>, rime::types::make_zero<Type>>::type
            operator()(Type const & n) const
        {
...
namespace callable {
    ...
    class less_sign_safe
    {
        ...
        template <class Left, class Right> static auto apply(
            ...
            typename boost::disable_if<boost::mpl::or_<
                ...
                type * = 0) RETURNS(rime::less(left, right));

        // Unsigned < signed: consider special case of signed < 0.
        template <class Unsigned, class Signed> static auto apply(
            Unsigned const & u, Signed const & s,
            typename boost::enable_if<boost::mpl::and_<
                types::is_unsigned<Unsigned>,
                types::is_signed<Signed>>>::type * = 0)
            RETURNS(
                rime::and_(
        ...
        template <class Signed, class Unsigned> static auto apply(
            Signed const & s, Unsigned const & u,
            typename boost::enable_if<boost::mpl::and_<
                types::is_signed<Signed>,
                types::is_unsigned<Unsigned>>>::type * = 0)
            RETURNS(
                rime::or_(
                    rime::less(s, rime::make_zero(s)),
        ...
        {
            typedef decltype(apply(
                std::declval<Left>(), std::declval<Right>())) type;
        };
