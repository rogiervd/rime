...
template <class Container, class ConstContainer>
    void test_detail_store_as_qualified()
{
    using std::is_same;
    using detail::storage::store_as;
...
BOOST_AUTO_TEST_CASE (test_detail_store_as) {
    struct container;
    test_detail_store_as_qualified <container, container const>();
    test_detail_store_as_qualified <container &, container const &>();
}

BOOST_AUTO_TEST_CASE (test_detail_get_as_moving) {
    using std::is_same;
    using detail::storage::get_as;
...
BOOST_AUTO_TEST_CASE (test_detail_get_pointer) {
    using std::is_same;
    using detail::storage::get_pointer;
