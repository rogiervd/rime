...
BOOST_AUTO_TEST_CASE(test_rime_variant_get_types)
{
    ...
    {
        variant v(6);
        BOOST_MPL_ASSERT((is_same<int &, decltype(rime::get<int>(v))>) );
        BOOST_MPL_ASSERT((is_same<float &, decltype(rime::get<float>(v))>) );
        BOOST_MPL_ASSERT((is_same<int &, decltype(rime::get<int &>(v))>) );
        BOOST_MPL_ASSERT(
            (is_same<int const &, decltype(rime::get<int const>(v))>) );
        BOOST_MPL_ASSERT(
            (is_same<int const &, decltype(rime::get<int const &>(v))>) );
        BOOST_MPL_ASSERT(
            (is_same<std::string &, decltype(rime::get<std::string>(v))>) );
        BOOST_MPL_ASSERT((is_same<void *&, decltype(rime::get<void *>(v))>) );
        BOOST_MPL_ASSERT(
            (is_same<converted &, decltype(rime::get<converted>(v))>) );
        BOOST_MPL_ASSERT((is_same<void, decltype(rime::get<void>(v))>) );

        BOOST_MPL_ASSERT(
            (is_same<int &&, decltype(rime::get<int>(make_variant(6)))>) );
        BOOST_MPL_ASSERT(
            (is_same<float &&, decltype(rime::get<float>(make_variant(6)))>) );
        BOOST_MPL_ASSERT(
            (is_same<int &, decltype(rime::get<int &>(make_variant(6)))>) );
        ...
        BOOST_MPL_ASSERT(
            (is_same<void *&&, decltype(rime::get<void *>(make_variant(6)))>) );
        BOOST_MPL_ASSERT((is_same<
                          converted &&,
        ...
        variant const vc(6);
        BOOST_MPL_ASSERT((is_same<int const &, decltype(rime::get<int>(vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<float const &, decltype(rime::get<float>(vc))>) );
        BOOST_MPL_ASSERT((is_same<int &, decltype(rime::get<int &>(vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<int const &, decltype(rime::get<int const>(vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<int const &, decltype(rime::get<int const &>(vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<
                std::string const &, decltype(rime::get<std::string>(vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<void * const &, decltype(rime::get<void *>(vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<converted const &, decltype(rime::get<converted>(vc))>) );
        BOOST_MPL_ASSERT((is_same<void, decltype(rime::get<void>(vc))>) );
        ...
        BOOST_MPL_ASSERT(
            (is_same<
                int &, decltype(rime::get<int &>(make_const_variant(6)))>) );
        BOOST_MPL_ASSERT(
            (is_same<
                int const &&,
        ...
        BOOST_MPL_ASSERT(
            (is_same<void, decltype(rime::get<void>(make_const_variant(6)))>) );

        BOOST_MPL_ASSERT(
            (is_same<int const *, decltype(rime::get<int>(&vc))>) );
        BOOST_MPL_ASSERT(
            (is_same<float const *, decltype(rime::get<float>(&vc))>) );
        /*BOOST_MPL_ASSERT ((is_same <fails,
...
BOOST_AUTO_TEST_CASE(test_rime_variant_move_construct)
{
    ...
    */
    ...
    }
    {
        ...
        BOOST_CHECK_EQUAL(
            make_const_other_variant(get_int_const()).which(), 3u);
    ...
    // 5 std::string
    {
        ...
        BOOST_CHECK_EQUAL(make_const_variant(std::string("Hello")).which(), 5u);
...
BOOST_AUTO_TEST_CASE(test_rime_variant_copy_construct)
{
    ...
    // 3 int const
    {
        ...
        BOOST_CHECK_EQUAL(
            &rime::get<int const &>(copied), &rime::get<int const>(v));

        variant copied_const(vc);
        BOOST_CHECK_EQUAL(copied_const.which(), 4u);
        BOOST_CHECK_EQUAL(rime::get<int const &>(copied_const), 5);
        BOOST_CHECK_EQUAL(
            &rime::get<int const &>(copied_const), &rime::get<int const>(vc));
    }
    {
        // From other variant type
...
{
    tracked_assignable & operator=(utility::tracked<> const &) { return *this; }
};
...
void test_rime_variant_objects_tracked()
{
    ...
    // Construction and destruction
    {
        ...
        BOOST_CHECK_EQUAL(
            registry.counts(),
            value_construct_count(1) + move_count(1) + destruct_count(1)
    ...
    // Copy-construction
    {
        ...
        BOOST_CHECK_EQUAL(
            registry.counts(),
            value_construct_count(1) + copy_count(2) + destruct_count(3));
        BOOST_CHECK(registry.finished());
    }
    ...
    // Move-construction
    {
        ...
        BOOST_CHECK_EQUAL(
            registry.counts(),
            value_construct_count(1) + move_count(2) + copy_count(0)
    ...
    // If the variant is a temporary, "get" should return an rvalue reference.
    {
        ...
        BOOST_CHECK_EQUAL(
            registry.counts(),
            value_construct_count(1) + move_count(4) + copy_count(0)
...
BOOST_AUTO_TEST_CASE(test_rime_variant_objects)
{
    ...
    // Moving from references.
    {
        utility::tracked_registry registry;
        {
            ...
            BOOST_CHECK_EQUAL(
                registry.counts(), value_construct_count(1) + copy_count(1));
        }
