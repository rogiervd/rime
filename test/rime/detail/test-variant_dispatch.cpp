...
{
    {
        typedef possible_actual_types_for<meta::vector<
            ...
            rime::variant<bool, double> const>>
            list;
        BOOST_MPL_ASSERT(
            (std::is_same<
                list::type,
                meta::vector<
                    meta::vector<int, bool>, meta::vector<int, double>,
                    meta::vector<long, bool>, meta::vector<long, double>>>) );
    }
    {
        typedef possible_actual_types_for<meta::vector<>> list;
        BOOST_MPL_ASSERT(
            (std::is_same<list::type, meta::vector<meta::vector<>>>) );
        BOOST_CHECK_EQUAL(list::get_index(), 0u);
    }
    {
        typedef possible_actual_types_for<meta::vector<int>> list;
        BOOST_MPL_ASSERT(
            (std::is_same<list::type, meta::vector<meta::vector<int>>>) );
    ...
    }
    {
        ...
        BOOST_MPL_ASSERT(
            (std::is_same<
                list::type, meta::vector<meta::vector<int const &>>>) );
        BOOST_CHECK_EQUAL(list::get_index(4), 0u);
    }
    {
        typedef possible_actual_types_for<meta::vector<int, long>> list;
        BOOST_MPL_ASSERT(
            (std::is_same<list::type, meta::vector<meta::vector<int, long>>>) );
    ...
    }
    {
        ...
        BOOST_MPL_ASSERT(
            (std::is_same<
                list::type, meta::vector<meta::vector<int const &, long>>>) );
        BOOST_CHECK_EQUAL(list::get_index(4, 5l), 0u);
    }
    {
        typedef possible_actual_types_for<
            meta::vector<rime::variant<int, long>>>
            list;
        BOOST_MPL_ASSERT(
            (std::is_same<
                list::type,
    ...
    {
        typedef possible_actual_types_for<
            meta::vector<rime::variant<int, long>, bool>>
            list;
        BOOST_MPL_ASSERT(
            (std::is_same<
                list::type,
                meta::vector<
                    meta::vector<int, bool>, meta::vector<long, bool>>>) );
    }
    {
        typedef possible_actual_types_for<
            meta::vector<bool, rime::variant<int, long> &>>
            list;
        BOOST_MPL_ASSERT(
            (std::is_same<
                list::type,
                meta::vector<
                    meta::vector<bool, int>, meta::vector<bool, long>>>) );
    }
    {
        typedef possible_actual_types_for<meta::vector<
            rime::variant<int, long> const &,
...
BOOST_AUTO_TEST_CASE(test_rime_detail_dispatch_runtime)
{
    ...
    {
        typedef possible_actual_types_for<
            meta::vector<rime::variant<int, long> const &, bool>>
            list;
...
BOOST_AUTO_TEST_CASE(test_rime_detail_dispatch_recipient)
{
    ...
    {
        typedef meta::vector<
            function &, rime::variant<int, void>, rime::variant<void, double>>
            arguments_type;

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, int, double>>
            d1;
        BOOST_CHECK_EQUAL(d1(f, 0, 3.), 3);

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, int, void>>
            d2;
        BOOST_CHECK_EQUAL(d2(f, 3, rime::variant<void, double>()), 1);

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, void, double>>
            d3;
        BOOST_CHECK_EQUAL(d3(f, rime::variant<int, void>(), 3.), 2);

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, void, void>>
            d4;
        BOOST_CHECK_EQUAL(
            d4(f, rime::variant<int, void>(), rime::variant<void, double>()),
            0);
    }

    {
        typedef meta::vector<
            function &, rime::variant<int, void>, rime::variant<void, char>,
            rime::variant<double, void>>
            arguments_type;

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, int, char, double>>
            d1;
        BOOST_CHECK_EQUAL(d1(f, 0, 'a', 3.), 4);

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, int, void, double>>
            d2;
        BOOST_CHECK_EQUAL(d2(f, 0, rime::variant<void, char>(), 3.), 3);

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, void, void, double>>
            d3;
        BOOST_CHECK_EQUAL(
            d3(f, rime::variant<int, void>(), rime::variant<void, char>(), 3.),
            2);

        rime::variant_detail::dispatch_recipient<
            arguments_type, meta::vector<function &, void, void, void>>
            d4;
        BOOST_CHECK_EQUAL(
            d4(f, rime::variant<int, void>(), rime::variant<void, char>(),
               rime::variant<double, void>()),
            0);
    }
}
